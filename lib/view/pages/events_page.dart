...
class EventsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: scope.communityEvents.fetchEvents(),
      builder: (BuildContext context, AsyncSnapshot<List<CommunityEvent>> snapshot) {
        ...
        final List<CommunityEvent> events = snapshot.data!;
        ...
        return ListView.separated(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            final CommunityEvent event = events[index - 1];
